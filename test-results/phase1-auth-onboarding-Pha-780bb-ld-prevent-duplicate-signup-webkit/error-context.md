...
- Name: phase1-auth-onboarding.spec.ts >> Phase 1: Authentication & Onboarding Flow >> should prevent duplicate signup
- Location: e2e/phase1-auth-onboarding.spec.ts:91:7
