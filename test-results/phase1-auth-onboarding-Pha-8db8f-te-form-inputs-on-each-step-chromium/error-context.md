...
- Name: phase1-auth-onboarding.spec.ts >> Phase 1: Authentication & Onboarding Flow >> should validate form inputs on each step
- Location: e2e/phase1-auth-onboarding.spec.ts:79:7
